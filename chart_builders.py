...
def build_placement_chart(player_rows, minimum_minutes=500, min_shots=10, min_margin=1.5):
    ...
    return {
        ...
        "blurb": (
            ...
            f"The dashed line is where the two are equal — a player sitting on it beat their chances purely by "
            f"placing shots well. Distance from the line, either way, is everything placement does not explain: "
